package com.ola.mlcontestapi.modules.user.controllers
...
class UsersController(private val userService: com.ola.mlcontestapi.modules.user.services.UserService) {
    @GetMapping("/current")
